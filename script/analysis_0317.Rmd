...
## sales analysis
```{sql, connection = my_db, output.var = "sales_analysis"}
...
```{sql, connection = my_db, output.var = "seller"}
...
The average amount of sales by each category is 75,443.85 pounds. Amongst 10 product categories, the sales amount of Automotive, Beauty_cosmetics, Home & garden, Furniture and pet_supplies are over the average sales amount by categories. 
